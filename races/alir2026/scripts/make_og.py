#!/usr/bin/env python3
"""Generate og.png (1200x630 social preview) for the ALIR 2026 dashboard.

Draws the Around Long Island course — ghost fleet, the routed course polyline,
Max (magenta, single hero) — as
...
Adapted from races/alir2025/scripts/make_og.py.
"""
...
def main():
  ...
  <path d="{path(mx['lon'], mx['lat'])}" fill="none" stroke="#C2187E" stroke-width="2.8"/>
  ...
  <text x="58" y="180" font-family="Helvetica Neue,Arial" font-size="58" font-weight="700" letter-spacing="4" fill="#C2187E">MAX</text>
  <text x="58" y="240" font-family="Helvetica Neue,Arial" font-size="34" font-weight="700" letter-spacing="3" fill="#17293A">TWO PARKS,</text>
  <text x="58" y="284" font-family="Helvetica Neue,Arial" font-size="34" font-weight="700" letter-spacing="3" fill="#17293A">ONE REACH</text>
  <text x="60" y="392" font-family="Menlo,monospace" font-size="18" fill="#4C6274">Around Long Island 2026</text>
  <text x="60" y="420" font-family="Menlo,monospace" font-size="18" fill="#4C6274">207 NM · 23–26 July</text>
  <text x="60" y="474" font-family="Menlo,monospace" font-size="18" fill="#17293A">45 finishers · a dead lane</text>
  <text x="60" y="502" font-family="Menlo,monospace" font-size="18" fill="#17293A">and a gate that repriced the fleet</text>
